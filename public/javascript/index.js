async function mySearch(){
    try{
        ...
        let searchUrl = "http://127.0.0.1:3000/search?pageNumber=1&pageSize=12&searchText=";
        if(searchText.value){
...
async function movePage(pageNumber){
    try{
        ...
        let searchUrl = "/search?pageNumber=" + pageNumber.toString() + "&pageSize=12&searchText=";
        if(searchText.value){
            searchUrl += searchText.value;
        }
        searchUrl += "&seller=";
